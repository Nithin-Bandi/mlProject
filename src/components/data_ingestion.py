...
from src.components.model_trainer import  Modeel_trainer_config,ModelTrainer
...
if __name__=='__main__':
    ...
    modetrain=ModelTrainer()
    print(modetrain.initiate_model_trainer(train_arr,test_arr))
